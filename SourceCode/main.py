...
from Experiments import runSingleSplitExample, runStaticExample, run_hyperparameter_optimization_example, \
    ...
    run_one_search_space, rerun_configs, run_MIP_EGO_experiment
...
def main():
    ...
    if len(sys.argv) == 2:
        ...
        run_MIP_EGO_experiment(int(sys.argv[1]))
    elif len(sys.argv) == 9:
        ...
        print(args)
        run = run_one_search_space(args.fid, args.target, args.budget, args.seed)
